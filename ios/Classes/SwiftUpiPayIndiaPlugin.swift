...
public class SwiftUpiPayIndiaPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "upi_pay_india", binaryMessenger: registrar.messenger())
    let instance = SwiftUpiPayIndiaPlugin()
